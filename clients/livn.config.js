module.exports = {
  client:   'Livn Gartenhaus',
  url:      'https://livn-gartenhaus.de',
  platform: 'shopify',
  ...
  customChecks: [],
  options: { waitAfterLoad: 3000, waitAfterATC: 2000, screenshotOnSuccess: false, checkBrokenLinks: true, checkConsoleErrors: true },
};
